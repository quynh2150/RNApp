...
const isEmpty = (value) => { return value == '' || value == undefined || value == null };

const ValidationRules = {
    match: (value, regexp) => {
        const validationReg = (regexp instanceof RegExp ? regexp : (new RegExp(regexp)));
        return (isEmpty(value) || validationReg.test(value));
    },
    ...
    maxNumber: (value, max) => parseInt(value, 10) <= parseInt(max, 10),

    minNumber: (value, min) => parseInt(value, 10) >= parseInt(min, 10),
